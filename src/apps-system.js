...
(() => {
        ...
        mount: async (w, options) => {
            ...
            async function render() {
                ...
                if (section === 'system') {
                    ...
                    main.append(OS.el('div', { class: 'card', html: '<h3>Built for the browser</h3><p class="muted" style="font-size:12px;line-height:1.8;margin:0">Built-in apps share Aster’s virtual file system. Imported HTML apps run in isolated frames without direct access to your desktop data. They may still make network requests. Only run code you trust. Native Windows executables, drivers, installers, and operating-system services are not supported.</p>' }));
    ...
    OS.register('welcome', { title: 'Welcome to Aster', description: 'Meet your new little corner of the internet.', category: 'System', width: 765, height: 680, minWidth: 370, singleton: true,
        mount: async (w) => {
            ...
            page.append(OS.el('div', { class: 'welcome-foot', html: '<strong style="color:var(--text)">A couple of things to know.</strong><br>Drag windows by their title bars. Hover over Maximize for snap layouts. Use Task View for more desktops. Press <kbd>Ctrl</kbd> + <kbd>Space</kbd> to find anything.<br><br>Your virtual files live in this browser, not in the cloud. Export a backup in Settings to keep them safe. Aster is a web desktop, not a bootable OS: it does not run native Windows programs or replace your real system.<br><br><span class="eyebrow" style="font-size:9px">INDEPENDENTLY BUILT · PLAIN HTML / CSS / JAVASCRIPT / WGSL</span>' }));
            w.body.append(page);
        }
    });
})();
